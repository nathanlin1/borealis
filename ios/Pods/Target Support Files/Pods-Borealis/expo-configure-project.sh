...
with_node \
  ...
  --target "/Users/aaronchu/Documents/borealis/ios/Pods/Target Support Files/Pods-Borealis/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-apple-authentication" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-web-browser"
